...
const menuItems = [
  { label: "Cơ sở y tế", dropdown: ["Bệnh viện công", "Bệnh viện tư", "Phòng khám", "Phòng mạch", "Xét nghiệm", "Y tế tại nhà", "Tiêm chủng"] },
  { label: "Dịch vụ y tế", dropdown: ["Đặt khám tại cơ sở", "Đặt khám theo bác sĩ", "Tư vấn khám bệnh qua video", "Đặt lịch xét nghiệm", "Gói khám sức khỏe", "Đặt lịch tiêm chủng", "Y tế tại nhà", "Thanh toán viện phí"] },
  { label: "Khám sức khỏe doanh nghiệp", dropdown: ["Dịch vụ khám tại sơ sở", "Dịch vụ khám tại công ty"] },
  { label: "Tin tức", dropdown: ["Tin dịch vụ", "Tin y tế", "Y học thường thức"] },
  { label: "Hướng dẫn", dropdown: ["Cài đặt ứng dụng", "Đặt lịch khám", "Tư vấn qua video", "Quy trình hoàn phí", "Câu hỏi thường gặp"] },
  { label: "Liên hệ hợp tác", dropdown: ["Tham gia BookingCare", "Quảng cáo", "Tuyển dụng", "Về BookingCare"] },
];
